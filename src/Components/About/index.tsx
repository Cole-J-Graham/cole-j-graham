    ...
    return (
        ...
        transition={{ duration: 1.5 }}>
             ...
             <FadeInText text="int main() {" el='h3' className='about-top-tags'/>
                <img className='about-pfp' src='src/assets/pfp.jpg'></img>
                <img className='right-arrow' src='src/assets/arrow.png'></img>
                <img className='left-arrow' src='src/assets/arrowleft.png'></img>
